...
<!-- Autorizacion 2 -->
<div class="modal" id="Importar" data-bs-backdrop="static" data-bs-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <a></a>
        <form  class="dropzone" action="{{route('Importar')}}" method="post" enctype="multipart/form-data" id="myAwesomeDropzone">
          {{ csrf_field() }}
        </form> 
      </div>
