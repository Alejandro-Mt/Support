            ...
            <div>
              ...
              @foreach ($sistemas as $sistema)
                <div class="row media">
                  ...
                  <div class="col-md-8">
                    <div class="mb-3">
                      <label type="text" class="form-control text-center">{{$sistema->nombre}}</label>
                    </div>
                  </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="mb-3 contact-email">
                                      <input type="text" name="nombre" class="form-control text-uppercase" value="{{$sistema->nombre}}"/>
                                      <span class="validation-text text-danger"></span>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="mb-3 contact-phone">
                                    <input type="text" name="dispercion" class="form-control" value="{{$sistema->email}}"/>
                                    <span class="validation-text text-danger"></span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  <div class="mb-3 contact-estatus">
                                    ...
                                    <!--<input type="binary" name="activo" class="form-control text-uppercase" value="{{$sistema->activo}}"/>-->
                                    <span class="validation-text text-danger"></span>
                                  </div>
                                </div>
                              </div>
