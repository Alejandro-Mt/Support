<div class="table-responsive">
  <table class="table">
    ...
    <tbody id="searchable">
      @foreach ($construccion as $registro)
        <tr id="{{$registro->folio}}"
              ...
              @foreach ($pausa as $pospuesto)
                @if ($registro->folio == $pospuesto->folio)
                  @if ($pospuesto->pausa == 2)
                    <button type="button" class="w-100 btn btn-rounded text-dark" data-bs-toggle="modal" data-bs-target="#estc{{$loop->parent->iteration}}">
          ...
          <div id="estc{{$loop->iteration}}" class="modal fade" tabindex="-1" aria-hidden="true">
          ...
          <div id="confc{{$loop->iteration}}" class="modal fade" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-body">
                    @foreach($pausa as $p)
