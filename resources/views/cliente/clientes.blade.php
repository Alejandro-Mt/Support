    ...
    <div class="card">
      <div class="el-card-item pb-3">
        <div class="el-card-avatar mb-3 el-overlay-1 w-100 overflow-hidden position-relative text-center">
          <object data="{{asset("assets/images/clientes/$proyecto->nombre_cl.png")}}" type="image/png"  width="130" height="130">
              ...
              <li class="el-item d-inline-block my-0 mx-1">
                <div class="el-card-content text-center">
                  <button id="" type="button" class="btn waves-effect waves-light btn-outline-secondary">
                    <a href="{{route('Prioridad',$proyecto->id_cliente)}}">
                ...
                <!--<a class="btn default btn-outline el-link text-dark border-dark" href="{{route('Prioridad',$proyecto->id_cliente)}}">
