...
var Emitter = (function () {
  ...
  Dropzone = (function () {
    ...
    function b(e, t) {
      ...
      if (
        ((n.options = b.extend({}, n.defaultOptions, o, null != t ? t : {})),
          ...
          value: function () {
            (this.prototype.Emitter = Emitter),
              ...
              (this.prototype.defaultOptions = {
                ...
                renameFile: null,
                forceFallback: !1,
                dictDefaultMessage: "Soltar archivos para carga",
                dictFallbackMessage:
                  ...
                  if (
                    ...
                    var l,
                      ...
                      u = _createForOfIteratorHelper(
                        t.previewElement.querySelectorAll("[data-dz-remove]")
                      );
                    try {
                      for (u.s(); !(l = u.n()).done; ) {
        ...
        [
              ...
              if (
                ...
                !(function r() {
                  return (
                    ...
                    (o.hiddenFileInput = document.createElement("input")),
                    o.hiddenFileInput.setAttribute("type", "file"),
                    (null === o.options.maxFiles || 1 < o.options.maxFiles) &&
                      o.hiddenFileInput.setAttribute("multiple", "multiple"),
                    (o.hiddenFileInput.className = "dz-hidden-input"),
                    ...
                    (o.hiddenFileInput.style.visibility = "hidden"),
                    (o.hiddenFileInput.style.position = "absolute"),
                    ...
                    o.hiddenFileInput.addEventListener("change", function () {
                      ...
                      click: function (e) {
                        return (
                          (t === o.element &&
                            ...
                            !b.elementInside(
                              e.target,
                              o.element.querySelector(".dz-message")
                            )) ||
              ...
              return (function () {
                ...
                try {
                  for (n.s(); !(e = n.n()).done; ) {
                    var i,
                      r = e.value;
                    null != r.webkitGetAsEntry && (i = r.webkitGetAsEntry())
                      ? i.isFile
                        ? t.push(a.addFile(r.getAsFile()))
                        : i.isDirectory
                        ? t.push(a._addFilesFromDirectory(i, i.name))
                        : t.push(void 0)
                      : null != r.getAsFile &&
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (((e.status = b.QUEUED), this.options.autoProcessQueue))
                return setTimeout(function () {
          ...
          },
          {
            ...
            value: function (e) {
              if (
                (e.status === b.UPLOADING && this.cancelUpload(e),
          ...
          },
          {
            ...
            value: function (o, a, l, s, t, u, e) {
              ...
              return (
                ...
                (t =
                  "from-image" !=
                    getComputedStyle(document.body).imageOrientation && t),
                (d.onload = function () {
                  var e = function (e) {
                    return e(1);
                  };
          ...
          },
          {
            ...
            value: function (e) {
              if (e.status === b.UPLOADING) {
                ...
                (e.status !== b.ADDED && e.status !== b.QUEUED) ||
                  ((e.status = b.CANCELED),
