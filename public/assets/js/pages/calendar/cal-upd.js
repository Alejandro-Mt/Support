!(function ($) {
    ...
    (CalendarApp.prototype.onDrop = function (eventObj, date) {
      ...
      $this.$calendar.fullCalendar("renderEvent", copiedEventObject, true);var titulo = copiedEventObject.title;
      ...
      (CalendarApp.prototype.onSelect = function (start, end, allDay) {
        ...
        form
          .find(".row")
          .append(
            "<div class='col-md-6'><div class='form-group'><label class='control-label'>Titulo del Evento</label><input class='form-control' placeholder='Titulo' type='text' name='title'/></div></div>"
          )
          .append(
            "<div class='col-md-6'><div class='form-group'><label class='control-label'>Categoria</label><select class='form-select' name='category'></select></div></div>"
          )
